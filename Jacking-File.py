...
RESET="\033[0m"
YELLOW="\033[1m\033[23m"
GREEN="\033[1m\033[33m"
RED="\033[1m\033[31m"
CYAN="\033[1m\033[36m"
...
M = "\033[1m\033[37m"
white = "\033[1m\033[37m"
purple = "\033[1m\033[38;5;208m"
reset = "\033[0m"
SCORPION = render('{Scorpion}', colors=['yellow', 'green'], align='center')
print(f'''\v
✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓✓  
...
a = print(f"""
{cyan}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
{cyan}┃ {red}-> {purple}Select The Year You Want To Hunt For {red}-> {cyan} ┃
{cyan}┃━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┃
{cyan}┃ {purple}-> {red}1{white} - {yellow}2011                             {cyan}    ┃
{cyan}┃ {purple}-> {red}2{white} - {yellow}2012                             {cyan}    ┃
{cyan}┃ {purple}-> {red}3{white} - {yellow}2013                             {cyan}    ┃
{cyan}┃ {purple}-> {red}4{white} - {yellow}2014                             {cyan}    ┃
{cyan}┃ {purple}-> {red}5{white} - {yellow}2015                             {cyan}    ┃
{cyan}┃ {purple}-> {red}6{white} - {yellow}2016                             {cyan}    ┃
{cyan}┃ {purple}-> {red}7{white} - {yellow}2017                             {cyan}    ┃
{cyan}┃ {purple}-> {red}8{white} - {yellow}2018                             {cyan}    ┃
{cyan}┃ {purple}-> {red}9{white} - {yellow}2019                             {cyan}    ┃
{cyan}┃ {purple}-> {red}0{white} - {yellow}2011 {white}~ {yellow}2023                  {cyan}        ┃
{cyan}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
""")
ParbhakarX = input(f"{green}-> {white}Please type the number of your choice: {reset}")
...
def check_aol(email):
    ...
    try:
        ...
        data = f'browser-fp-data=%7B%22language%22%3A%22en-US%22%2C%22colorDepth%22%3A24%2C%22deviceMemory%22%3A8%2C%22pixelRatio%22%3A1%2C%22hardwareConcurrency%22%3A4%2C%22timezoneOffset%22%3A-60%2C%22timezone%22%3A%22Africa%2FCasablanca%22%2C%22sessionStorage%22%3A1%2C%22localStorage%22%3A1%2C%22indexedDb%22%3A1%2C%22cpuClass%22%3A%22unknown%22%2C%22platform%22%3A%22Win32%22%2C%22doNotTrack%22%3A%22unknown%22%2C%22plugins%22%3A%7B%22count%22%3A5%2C%22hash%22%3A%222c14024bf8584c3f7f63f24ea490e812%22%7D%2C%22canvas%22%3A%22canvas%20winding%3Ayes~canvas%22%2C%22webgl%22%3A1%2C%22webglVendorAndRenderer%22%3A%22Google%20Inc.%20(Intel)~ANGLE%20(Intel%2C%20Intel(R)%20HD%20Graphics%204000%20(0x00000166)%20Direct3D11%20vs_5_0%20ps_5_0%2C%20D3D11)%22%2C%22adBlock%22%3A0%2C%22hasLiedLanguages%22%3A0%2C%22hasLiedResolution%22%3A0%2C%22hasLiedOs%22%3A0%2C%22hasLiedBrowser%22%3A0%2C%22touchSupport%22%3A%7B%22points%22%3A0%2C%22event%22%3A0%2C%22start%22%3A0%7D%2C%22fonts%22%3A%7B%22count%22%3A33%2C%22hash%22%3A%22edeefd360161b4bf944ac045e41d0b21%22%7D%2C%22audio%22%3A%22124.03347527516074%22%2C%22resolution%22%3A%7B%22w%22%3A%221600%22%2C%22h%22%3A%22900%22%7D%2C%22availableResolution%22%3A%7B%22w%22%3A%22860%22%2C%22h%22%3A%221600%22%7D%2C%22ts%22%3A%7B%22serve%22%3A1704793094844%2C%22render%22%3A1704793096534%7D%7D&specId={specId}&cacheStored=&crumb={crumb}&acrumb={acrumb}&sessionIndex={sessionIndex}&done=https%3A%2F%2Fwww.aol.com&googleIdToken=&authCode=&attrSetIndex=0&specData={specData}&multiDomain=&tos0=oath_freereg%7Cus%7Cen-US&firstName=ahmed&lastName=Mahos&userid-domain=yahoo&userId={name}&password=Drahmed2006##$$&mm=10&dd=24&yyyy=2000&signup='
...
def rest(user):
  try:
    headers = {
    'X-Pigeon-Session-Id': '50cc6861-7036-33b4-802e-fb4282799c60',
    'X-Pigeon-Rawclienttime': '1700251574.982',
    'X-IG-Connection-Speed': '-1kbps',
    'X-IG-Bandwidth-Speed-KBPS': '-1.000',
    'X-IG-Bandwidth-TotalBytes-B': '0',
    'X-IG-Bandwidth-TotalTime-MS': '0',
    'X-Bloks-Version-Id': 'c80c5fb30dfae9e273e4009f03b18280bb333b0862d663f31a3c63f13a9f31c0',
    'X-IG-Connection-Type': 'WIFI',
    'X-IG-Capabilities': '3brTvw==',
    'X-IG-App-ID': '567067333352427',
    ...
    data = {
    'signed_body': '0d067c2f86cac2c17d655631c9cec2402012fb0a329bcafb3b1f4c0bb56b1f1f.{"_csrftoken":"9y3N5kLqzialQA7z96AMiyAKLMBWpqVj","adid":"0dfaf820-2748-4634-9365-c3d8c8011256","guid":"1f784331-2663-4db9-b624-86bd9ce1d084","device_id":"android-b93ddb37e983481c","query":"'+user+'"}',
    'ig_sig_key_version': '4',
  }
...
def date(hy):
    try:
        ranges = [
            ...
            (9009900000000, 2013),
            (16290100000000, 2014),
            (250000000000000, 2015),
            (3713668784744546, 2016),
            (56997858213744557, 2017),
            (859793924447444645, 2018),
            (2125402833553464534, 2019),
            (33464475393574464495, 2020),
            (5028927886363343353347, 2021),
            (57464098536435554447082, 2022),
            (633134986626275457544598, 2023)
...
||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||---
By @parbhakar_285 Join @scor1yan
'''

    with open('scorp.txt', 'a') as ff:
        ff.write(f'{ss}\n')
